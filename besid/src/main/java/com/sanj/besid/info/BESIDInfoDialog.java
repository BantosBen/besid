...
public class BESIDInfoDialog extends AlertDialog {
    ...
    public interface BESIDInfoDialogInterface {
    ...
    public static class Builder {
        ...
        public Builder setActionButton(String buttonText, BESIDInfoDialogInterface.OnClickListener onClickListener) {
            params.buttonText = buttonText;
            params.onClickListener = onClickListener;
            return this;
        }

        public Builder setActionButton(int buttonTextId, BESIDInfoDialogInterface.OnClickListener onClickListener) {
        ...
        public AlertDialog build() throws BESIDException {
            ...
            return new BESIDInfoDialog(params);
        }
    ...
    private static class Params {
        ...
        public String message = "", title = "", buttonText = "Okay, I understand";
        public int messageId = 0, titleId = 0;
        public boolean cancelable = true; //default dialog behavior
        public BESIDInfoDialogInterface.OnClickListener onClickListener = AppCompatDialog::dismiss;
    }
}
